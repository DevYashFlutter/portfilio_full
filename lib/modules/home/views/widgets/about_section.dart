            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  ...
                  if (isMobile)
                    Column(children: [const _AboutExperienceTimeline(), const SizedBox(height: 80), const _AboutSkillsSection()])
                  else
                    const Row(
        ...
        Positioned(
          ...
          child:
              Container(
                    width: 400,
                    height: 400,
                    decoration: BoxDecoration(color: const Color(0xFFA855F7).withValues(alpha: 0.05), shape: BoxShape.circle),
                  )
                  .animate(onPlay: (c) => c.repeat())
                  .scale(begin: const Offset(1, 1), end: const Offset(1.2, 1.2), duration: const Duration(seconds: 8), curve: Curves.easeInOut)
                  .custom(
                    builder: (context, value, child) => Opacity(opacity: 0.2 + (value * 0.2), child: child),
                  )
...
class _AboutHighlightsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final highlights = [
      {'icon': Icons.business_center_rounded, 'title': 'Large-Scale Production', 'desc': 'Apps used by millions of users daily'},
      {'icon': Icons.bolt_rounded, 'title': 'Performance Optimization', 'desc': 'Reduced app load time by 40%'},
      {'icon': Icons.emoji_events_rounded, 'title': 'Cross-Platform Expert', 'desc': 'Single codebase for iOS & Android'},
      {'icon': Icons.groups_rounded, 'title': 'Scalable Architecture', 'desc': 'Clean code & maintainable solutions'},
    ];
...
class _HighlightCard extends StatefulWidget {
  ...
  const _HighlightCard({required this.icon, required this.title, required this.desc, required this.index});
    ...
    return MouseRegion(
      ...
      child:
          AnimatedContainer(
                    ...
                    AnimatedOpacity(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          gradient: RadialGradient(colors: [const Color(0xFFA855F7).withValues(alpha: 0.2), Colors.transparent], radius: 1.0),
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                              color: isHovered ? const Color(0xFFA855F7).withValues(alpha: 0.6) : const Color(0xFFA855F7).withValues(alpha: 0.2),
                              width: 1,
                            ),
                            boxShadow: isHovered
                                ? [BoxShadow(color: const Color(0xFFA855F7).withValues(alpha: 0.1), blurRadius: 20, spreadRadius: 5)]
                                : [],
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [const Color(0xFFA855F7).withValues(alpha: 0.2), const Color(0xFF06B6D4).withValues(alpha: 0.2)],
                                  ),
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Icon(widget.icon, color: const Color(0xFFC084FC), size: 24),
                              ),
                              ...
                              Text(widget.desc, style: const TextStyle(fontSize: 14, color: Color(0xFF94A3B8), height: 1.5)),
                            ],
                          ),
                        ),
                      ),
              ...
              .scale(begin: const Offset(1, 1), end: const Offset(1.02, 1.02), duration: const Duration(milliseconds: 200)),
    );
  }
}
...
class _AboutExperienceTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        .moveX(begin: -30, end: 0, duration: const Duration(milliseconds: 800), delay: const Duration(milliseconds: 300));
  }
}
...
class _TimelineItem extends StatefulWidget {
  ...
  const _TimelineItem({required this.period, required this.role, required this.company, required this.achievements});
                  ...
                  child: BackdropFilter(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: isHovered
                            ? [BoxShadow(color: const Color(0xFFA855F7).withValues(alpha: 0.1), blurRadius: 20, spreadRadius: 2)]
                            : [],
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
...
class _PulsingDot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        .then()
        .scale(begin: const Offset(1.5, 1.5), end: const Offset(1, 1), duration: const Duration(seconds: 1), curve: Curves.easeInOut)
        .custom(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
          ...
          children: [
            ...
            ...List.generate(
              skills.length,
              (index) => _SkillBar(name: skills[index]['name'] as String, level: (skills[index]['level'] as int).toDouble(), index: index),
            ),
            const SizedBox(height: 40),
...
class _SkillBar extends StatelessWidget {
  ...
  const _SkillBar({required this.name, required this.level, required this.index});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                '${level.toInt()}%',
                style: const TextStyle(color: Color(0xFFC084FC), fontWeight: FontWeight.w500),
              ),
            ],
          ),
          const SizedBox(height: 12),
          Container(
            ...
            child: FractionallySizedBox(
              ...
              child:
                  Container(
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [Color(0xFFA855F7), Color(0xFF06B6D4)]),
...
class _AboutStatsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.count(
      ...
      children: List.generate(
        stats.length,
        (index) => _StatCard(value: stats[index]['value'] as String, label: stats[index]['label'] as String, index: index),
      ),
    );
  }
}
...
class _StatCard extends StatefulWidget {
  ...
  const _StatCard({required this.value, required this.label, required this.index});
